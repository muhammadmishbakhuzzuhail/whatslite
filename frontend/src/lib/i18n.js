...
const dict = {
  id: {
    ...
    status_new: "Status teks baru", status_placeholder: "Ketik status…", status_posted: "Status diunggah", status_failed: "Gagal mengunggah status", status_photo: "Status foto/video",
    ...
    mic_denied: "Mikrofon tak bisa diakses", edit_message: "Edit pesan", archived_chats: "Chat diarsipkan", no_archived: "Tak ada chat diarsipkan", messages_label: "Pesan", notif_sound: "Suara notifikasi", save: "Simpan", wallpaper: "Wallpaper chat", wp_none: "Tanpa",
    group_edit_name: "Ubah nama grup", group_add_member: "Tambah anggota", group_add_prompt: "Nomor telepon (mis. 62812…)", invite_link: "Tautan undangan", invite_copied: "Tautan undangan disalin",
    ...
    attach_media: "Foto & video", attach_location: "Lokasi", attach_poll: "Polling", attach_contact: "Kontak", attach_once: "Foto sekali lihat", attach_sticker: "Stiker", stk_recents: "Baru dipakai", stk_create: "Buat", stk_pick: "Pilih gambar", stk_hint: "Background dihapus otomatis", stk_processing: "Memproses… (hapus background)", stk_no_recents: "Belum ada stiker", sticker_bg_failed: "Gagal hapus background; pakai gambar utuh", poll_new: "Buat polling", poll_question: "Pertanyaan", poll_option: "Opsi", poll_add_option: "Tambah opsi", poll_voted: "Suara terkirim", poll_votes_n: "suara",
    loc_unavailable: "Lokasi tak tersedia", loc_denied: "Akses lokasi ditolak", disappearing_off: "Mati", disappearing_24h: "24 jam", disappearing_7d: "7 hari", disappearing_90d: "90 hari", select_messages: "Pilih pesan", selected_n: "%n dipilih",
  ...
  en: {
    ...
    status_new: "New text status", status_placeholder: "Type a status…", status_posted: "Status posted", status_failed: "Failed to post status", status_photo: "Photo/video status",
    ...
    mic_denied: "Microphone unavailable", edit_message: "Edit message", archived_chats: "Archived chats", no_archived: "No archived chats", messages_label: "Messages", notif_sound: "Notification sound", save: "Save", wallpaper: "Chat wallpaper", wp_none: "None",
    group_edit_name: "Edit group name", group_add_member: "Add member", group_add_prompt: "Phone number (e.g. 1555…)", invite_link: "Invite link", invite_copied: "Invite link copied",
    ...
    attach_media: "Photos & videos", attach_location: "Location", attach_poll: "Poll", attach_contact: "Contact", attach_once: "View-once photo", attach_sticker: "Sticker", stk_recents: "Recent", stk_create: "Create", stk_pick: "Pick image", stk_hint: "Background removed automatically", stk_processing: "Processing… (removing background)", stk_no_recents: "No stickers yet", sticker_bg_failed: "Background removal failed; using full image", poll_new: "Create poll", poll_question: "Question", poll_option: "Option", poll_add_option: "Add option", poll_voted: "Vote sent", poll_votes_n: "votes",
    loc_unavailable: "Location unavailable", loc_denied: "Location access denied", disappearing_off: "Off", disappearing_24h: "24 hours", disappearing_7d: "7 days", disappearing_90d: "90 days", select_messages: "Select messages", selected_n: "%n selected",
  ...
  es: {
    ...
    status_new: "Nuevo estado de texto", status_placeholder: "Escribe un estado…", status_posted: "Estado publicado", status_failed: "Error al publicar estado", status_photo: "Estado de foto/video",
    ...
    mic_denied: "Micrófono no disponible", edit_message: "Editar mensaje", archived_chats: "Chats archivados", no_archived: "No hay chats archivados", messages_label: "Mensajes", notif_sound: "Sonido de notificación", save: "Guardar", wallpaper: "Fondo de chat", wp_none: "Ninguno",
    group_edit_name: "Editar nombre del grupo", group_add_member: "Añadir miembro", group_add_prompt: "Número de teléfono (ej. 52155…)", invite_link: "Enlace de invitación", invite_copied: "Enlace copiado",
    ...
    attach_media: "Fotos y videos", attach_location: "Ubicación", attach_poll: "Encuesta", attach_contact: "Contacto", attach_once: "Foto de una vez", attach_sticker: "Sticker", stk_recents: "Recientes", stk_create: "Crear", stk_pick: "Elegir imagen", stk_hint: "Fondo eliminado automáticamente", stk_processing: "Procesando… (quitando fondo)", stk_no_recents: "Sin stickers aún", sticker_bg_failed: "Fallo al quitar fondo; usando imagen completa", poll_new: "Crear encuesta", poll_question: "Pregunta", poll_option: "Opción", poll_add_option: "Añadir opción", poll_voted: "Voto enviado", poll_votes_n: "votos",
    loc_unavailable: "Ubicación no disponible", loc_denied: "Acceso a ubicación denegado", disappearing_off: "Desactivado", disappearing_24h: "24 horas", disappearing_7d: "7 días", disappearing_90d: "90 días", select_messages: "Seleccionar mensajes", selected_n: "%n seleccionados",
