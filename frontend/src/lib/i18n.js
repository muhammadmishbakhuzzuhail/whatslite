...
const dict = {
  id: {
    ...
    emoji: "Emoji", attach: "Lampirkan", voice_msg: "Pesan suara", recording: "Merekam… ketuk kirim untuk selesai", voice_unsupported: "Rekam suara tak didukung di sini", send: "Kirim", cancel: "Batal",
  ...
  en: {
    ...
    emoji: "Emoji", attach: "Attach", voice_msg: "Voice message", recording: "Recording… tap send to finish", voice_unsupported: "Voice recording not supported here", send: "Send", cancel: "Cancel",
  ...
  es: {
    ...
    emoji: "Emoji", attach: "Adjuntar", voice_msg: "Mensaje de voz", recording: "Grabando… toca enviar para terminar", voice_unsupported: "Grabación de voz no soportada aquí", send: "Enviar", cancel: "Cancelar",
